...
CREATE TABLE `sry_recordsforaverageandgtotal` (
  `sry_recordsForAverageAndGtotal_id` int(11) NOT NULL,
...
ALTER TABLE `sry_recordsforaverageandgtotal`
  ADD PRIMARY KEY (`sry_recordsForAverageAndGtotal_id`),
...
--
ALTER TABLE `sry_recordsforaverageandgtotal`
  MODIFY `sry_recordsForAverageAndGtotal_id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
