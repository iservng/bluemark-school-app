...
require_once BUSINESS_DIR . 'students.php';
require_once BUSINESS_DIR . 'studentreportcard.php';

require_once BUSINESS_DIR . 'orders.php';
require_once BUSINESS_DIR . 'teachers.php';
...
require_once BUSINESS_DIR . 'student_pin.php';
require_once BUSINESS_DIR . 'applicants.php';

//Validation class 
require_once BUSINESS_DIR . 'validator.php';
require_once BUSINESS_DIR . 'fields.php';

//Image resizer class
require_once BUSINESS_DIR . 'image_util.php';
...
{
    //Headers are sent to pevent browswers from caching
...
{
    $application->display(STORE_FRONT);
}
