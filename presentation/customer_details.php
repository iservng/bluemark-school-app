...
class CustomerDetails
{
    ...
    {
        //If we have a new user or editing existing customer details
    ...
    public function init()
    {
        ...
        if(isset($_POST['sended']) && ($this->_mErrors == 0))
        {
            ...
            $customer_read = Customer::GetLoginInfor($this->mEmail);
            ...
            //If we have a new user or we are updating an existing user's details
            if($this->mEditMode == 0)
