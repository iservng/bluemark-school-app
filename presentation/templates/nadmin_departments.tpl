...
<head>
    ...
    <!-- Morris Charts CSS -->
    <link href="{$obj->mSiteUrl}/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="{$obj->mSiteUrl}/vendor/raphael/raphael.min.js"></script>
    <script src="{$obj->mSiteUrl}/vendor/morrisjs/morris.min.js"></script>
    <script src="{$obj->mSiteUrl}/data/morris-data.js"></script>
