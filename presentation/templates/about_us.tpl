...
{include file="feature_area.tpl"}<br><br>

<section class="info-area pb-120">
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-lg-6 no-padding info-area-left">
							<img class="img-fluid" src="{$obj->mSiteUrl}img/about-img.jpg" alt="">
						</div>
...
<a class="play-btn" href="{$obj->mSiteUrl}videos/artificial.mp4"><img class="img-fluid mx-auto" src="{$obj->mSiteUrl}img/play.png" alt=""></a>
                        </div>
                    </div>
				</div>	
			</section>
					...
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-lg-4 col-md-6 search-course-right section-gap">
							<form class="form-wrap" action="#">
								<h4 class="text-white pb-20 text-center mb-30">Register as a parent</h4>		
