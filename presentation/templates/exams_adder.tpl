                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b style="color: #337ab7">Enter the Exams scores for {$obj->mSubjectName}</b>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="well">
                                ...
                                <p></p>
<input type="submit" class="btn btn-success btn-lg btn-block" value="Submit Exams scores for {$obj->mSubjectName}" style="font-weight: bold;" name="examsForStorage">
                            </div>
                        </div>
                        {else}
