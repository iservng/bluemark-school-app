 {load_presentation_object filename="primary_specific" assign="obj"}
...
<div id="page-wrapper">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                <div class="col-lg-12">
                <b> <a href="{$obj->mLinkApplicantsData}">Back</a> | Applicants into Primary Section</b>
                <hr>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                {section name=i loop=$obj->mPrimaryApplicantsRecords}
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            {$obj->mPrimaryApplicantsRecords[i].firstname}
                                            <span>&nbsp;</span>
                                            {$obj->mPrimaryApplicantsRecords[i].surname}
                                        </td>

                                        <td>
                                            {$obj->mPrimaryApplicantsRecords[i].email}
                                        </td>

                                        <td>
                                            {$obj->mPrimaryApplicantsRecords[i].f_phone}
                                        </td>

                                        <td class="center">
                                        
                                            {$obj->mPrimaryApplicantsRecords[i].applied_on}
                                        </td>
                            ...
                            <div class="well">
                                ...
                                <p>
                                 <form method="post" action="{$obj->mLinkToPrimarySpecificData}">
