 {load_presentation_object filename="secondary_specific" assign="obj"}
...
<div id="page-wrapper">
            <div class="row">
                ...
                <!-- /.col-lg-12 -->
                <div class="col-lg-12">
                <b> <a href="{$obj->mLinkApplicantsData}">Back</a> | Applicants into Secondary Section</b>
                <hr>
                </div>
            </div>
 ...
 <p style="color: red;">There are no Application for admission records found for the current or specified year! <a href="{$obj->mLinkApplicantsData}"><b>Back</b></a> </p><br>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                {section name=i loop=$obj->mSecondaryApplicantsRecords}
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            {$obj->mSecondaryApplicantsRecords[i].firstname}
                                            <span>&nbsp;</span>
                                            {$obj->mSecondaryApplicantsRecords[i].surname}
                                        </td>

                                        <td>
                                            {$obj->mSecondaryApplicantsRecords[i].email}
                                        </td>

                                        <td>
                                            {$obj->mSecondaryApplicantsRecords[i].f_phone}
                                        </td>

                                        <td class="center">
                                        
                                            {$obj->mSecondaryApplicantsRecords[i].applied_on}
                                        </td>

                                        <td class="center">
                                            {* {$obj->mPrimaryApplicantsRecords[i].status} |  *}
                            ...
                            <div class="well">
                                ...
                                <p>
                                 <form method="post" action="{$obj->mLinkToSecondarySpecificData}">
