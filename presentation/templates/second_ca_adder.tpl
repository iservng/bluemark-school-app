                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <b style="color: #337ab7">Enter the second CA score for {$obj->mSubjectName}</b>
                        </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="well">
                                ...
                                <p></p>
<input type="submit" class="btn btn-success btn-lg btn-block" value="Submit second CA scores for {$obj->mSubjectName}" style="font-weight: bold;" name="secondCaForStorage">
                            </div>
                        </div>
                        {else}
