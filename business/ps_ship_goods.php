...
class PsShipGoods implements IPipelineSection 
{
    ...
    public function Process($processor)
    {
        ...
        $processor->MailSupplier(STORE_NAME . ' ship goods.', $this->GetMailBody());

        //Audit
        $processor->CreateAudit('Ship goods email sent to supplier.', 20502);
    ...
    {
        $body = 'Payment has been recieved for the following goods:';
        $body .= "\n\n";
        ...
        $body .= 'When goods have been shipped, please confirm via ' . Link::ToAdmin();
        $body .= "\n\n";
