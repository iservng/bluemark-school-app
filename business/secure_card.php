...
class SecureCard
{
    //Private containing credit card's details
    ...
    //Encrypt data
    public function LoadPlainDataAndEncrypt($newCardHolder, $newCardNunber, $newIssueDate, $newExpiryDate, $newIssueNumber, $newCardType)
    {
        $this->_mCardHolder = $newCardHolder;
        $this->_mCardNumber = $newCardNunber;
    ...
    //Extract information from XML crdit card data
