...
//Ensures that dates and time a set to africa lagos 
...
require_once BUSINESS_DIR . 'date_week.php';
...
require_once BUSINESS_DIR . 'string.php';
...
//Display the page
$application->display('staff_admin.tpl');
